...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sentolo = new LatLng(-7.8296569, 110.2163330);
        mMap.addMarker(new MarkerOptions().position(sentolo).title("Marker in Sentolo"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(sentolo));
